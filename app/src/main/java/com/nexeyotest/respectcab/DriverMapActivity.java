...
//                    FinanceBalance_Model fin = snapshot.getValue(FinanceBalance_Model.class);
        ...
        mEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(DriverMapActivity.this,R.style.MaterialThemeDialog);
                final EditText input = new EditText(DriverMapActivity.this);
                builder.setView(input);
                input.setVisibility(View.INVISIBLE);
                input.setHint("Enter voucher code here");

                final TextView myMsg = new TextView(DriverMapActivity.this);
                ...
                final TextView confirm_title = new TextView(DriverMapActivity.this);
...
//                builder.setTitle(myMsg+"Choose Payment Method");
                ...
                builder.setSingleChoiceItems(listItems, checkedItem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DriverMapActivity.this, "Position: " + which + " Value: " + listItems[which], Toast.LENGTH_LONG).show();
                ...
                builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog2, int which) {
                        ...
                        final AlertDialog.Builder alert = new AlertDialog.Builder(DriverMapActivity.this,R.style.MaterialThemeDialog);
                        alert
...
//                                            WebView1.loadUrl("file:///android_asset/sample.html");
                                            ...
                                            if(to.isEmpty()){
                                                Toast.makeText(DriverMapActivity.this, "You must enter a recipient email", Toast.LENGTH_LONG).show();
                                            }else if(subject.isEmpty()){
                                                Toast.makeText(DriverMapActivity.this, "You must enter a Subject", Toast.LENGTH_LONG).show();
                                            }else if(message.isEmpty()){
                                                Toast.makeText(DriverMapActivity.this, "You must enter a message", Toast.LENGTH_LONG).show();
                                            }else {
...
//                break;
            case R.id.nav_googlemap:
                ...
                if (launchIntent != null) {
                    ...
                    Toast.makeText(DriverMapActivity.this, "There is no package available in android", Toast.LENGTH_LONG).show();
                }
                break;
        }
