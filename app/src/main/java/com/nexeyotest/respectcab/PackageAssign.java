...
public class PackageAssign extends AppCompatActivity {
                        ...
                        alert
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        Intent intent = new Intent(PackageAssign.this, DriverPackageActivity.class);
...
//                d_id = driver_id_f.getText().toString();
    ...
    private void firebaseUserSearch4(String pkg_name,String dr_id) {
        ...
        FirebaseRecyclerAdapter<PackageModel, PackageAssign.PackageAssignViewHolder> firebaseRecyclerAdapter_package_assign = new FirebaseRecyclerAdapter<PackageModel, PackageAssign.PackageAssignViewHolder>(
                PackageModel.class,
                R.layout.assign_package_trip,
                PackageAssign.PackageAssignViewHolder.class,
                firebaseSearchQuery_package
        ) {
            @Override
            protected void populateViewHolder(PackageAssign.PackageAssignViewHolder viewHolder, PackageModel model, int position) {
...
//                editortype.putString("carcharge", vehiclecharge_f.getText().toString());
    ...
    private void firebaseUserSearchPackage() {
        ...
        FirebaseRecyclerAdapter<CustomerEmail_Model, UsersViewHolderPackage> firebaseRecyclerAdapterPackage = new FirebaseRecyclerAdapter<CustomerEmail_Model, PackageAssign.UsersViewHolderPackage>(
                CustomerEmail_Model.class,
                R.layout.assign_package_email,
                PackageAssign.UsersViewHolderPackage.class,
                firebaseSearchQueryPackage
        ) {
            @Override
            protected void populateViewHolder(PackageAssign.UsersViewHolderPackage viewHolder, CustomerEmail_Model model, int position) {
